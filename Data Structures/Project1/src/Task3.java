...
//Fixed this task in the same ways as task 1, cast user input to be capitalized
//so the user doesn't have to worry about it, as well as the condition
//for the do while loop.
//Also added another treemap so get the print format to look nicer. Now,
//instead of {1=Jacob}, {2=...}, .... the format will look like
//1 Jacob
//2 ...
